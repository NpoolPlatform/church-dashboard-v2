...
export enum V1CurrencyFeedType {
...
export interface V1GetCurrenciesRequest {
  CoinTypeIDs?: string[];
  /** @format int64 */
  StartAt?: number;
  /** @format int64 */
...
export interface V1GetCurrenciesResponse {
  Infos?: V1Currency[];
  /** @format int64 */
  Total?: number;
}
...
/**
 * @title npool/chain/gw/v1/coin/fiat/currency/history/history.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  v1 = {
     ...
     *
     * @tags Gateway
     * @name GatewayGetCurrencies
     * @request POST:/v1/get/coinfiatcurrencyhistories
     */
    gatewayGetCurrencies: (body: V1GetCurrenciesRequest, params: RequestParams = {}) =>
      this.request<V1GetCurrenciesResponse, RpcStatus>({
        path: `/v1/get/coinfiatcurrencyhistories`,
        method: "POST",
        body: body,
