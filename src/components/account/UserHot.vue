...
const displayUserBenefitHots = computed(() => userBenefitHots.value.filter((el) => {
  let flag = true
...
const onCreate = () => {
  ...
  target.value = { UsedFor: AccountUsedFor.UserBenefitHot } as PlatformAccount
}
